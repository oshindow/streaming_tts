...
model = AutoModelForCausalLM.from_pretrained(llasa_3b,
                                            ...
                                            attention_sink_window_size=10)
# print("Load attention_sinks Qwen2 model from", pretrain_path)
# print(model)
###
...
with torch.no_grad():
    ...
    print("Speech tokens shape:", speech_tokens.shape)
    torch.save(speech_tokens, "speech_tokens_attn_sink.pt") # Speech tokens shape: torch.Size([1, 1, 905])
    # Decode the speech tokens to speech waveform
    # gen_wav = Codec_model.decode_code(speech_tokens) 
 

# sf.write("gen_zh.wav", gen_wav[0, 0, :].cpu().numpy(), 16000)
